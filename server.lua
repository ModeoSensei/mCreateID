...
RegisterNetEvent('modeo:BuyCarte')
AddEventHandler('modeo:BuyCarte', function()
    ...
    if xMoney >= price then
        ...
        TriggerClientEvent('esx:showNotification', source, "~g~Achats~w~ effectué ! (~g~+100$~w~)")
    else
         TriggerClientEvent('esx:showNotification', source, "Vous n'avez assez ~r~d\'argent")
    end
end)

RegisterNetEvent('modeo:UnBuyCarte')
AddEventHandler('modeo:UnBuyCarte', function()
    ...
    if xMoney >= price then
        ...
        xPlayer.removeInventoryItem('carteid', 1)
        TriggerClientEvent('esx:showNotification', source, "~r~Achats~w~ effectué ! (~r~-100$~w~)")
    else
         TriggerClientEvent('esx:showNotification', source, "Vous n'avez assez ~r~d\'argent")
    end
end)
